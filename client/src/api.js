...
// ---------------------------------------------------------------------------
export const getCommsStatus = (stationId) =>
  client.get(`/comms/${stationId}/status`).then((r) => r.data);
export const toggleSatellite = (stationId) =>
  client.post(`/comms/${stationId}/toggle-satellite`).then((r) => r.data);
