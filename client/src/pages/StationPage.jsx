...
import ResiliencePanel, { CommsStrip } from '../components/ResiliencePanel';

const TABS = ['Overview', '2D Map', 'Energy', 'Environment', 'Logistics', 'Alerts', 'AI Insights', 'Resilience'];
    ...
    <div className="min-h-screen bg-bg">
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="py-6">
          ...
          {activeTab === 'Resilience' && <ResiliencePanel stationId={id} />}
        </div>
      </div>
    </div>
  );
...
function OverviewTab({ station, alertCount }) {
  ...
  return (
    <div className="space-y-4">
      <CommsStrip stationId={station.id} />
